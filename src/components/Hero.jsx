...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute top-20 left-10 w-72 h-72 bg-primary-200 rounded-full blur-[100px] opacity-40" />
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-primary-300 rounded-full blur-[120px] opacity-30" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-secondary-200 rounded-full blur-[150px] opacity-20" />

      {/* Floating shapes */}
      <div className="absolute top-32 right-[15%] w-16 h-16 border-2 border-primary-300 rounded-2xl rotate-12 opacity-50 animate-bounce" style={{ animationDuration: '3s' }} />
      <div className="absolute bottom-40 left-[12%] w-12 h-12 bg-primary-400 rounded-full opacity-30 animate-bounce" style={{ animationDuration: '4s' }} />
      <div className="absolute top-[20%] left-[20%] w-8 h-8 border-2 border-secondary-300 rounded-full opacity-40 animate-pulse" />
